...
function invoke_chaincode(chaincode_id, function_name, arg_list) {
    ...
    var peer = fabric_client.newPeer('grpc://peer0.org2.example.com:7051');
    channel.addPeer(peer);
    ...
    return Fabric_Client.newDefaultKeyValueStore({ path: store_path
        ...
        if (isProposalGood) {
            ...
            //let event_hub = channel.newChannelEventHub('grpc://peer0.org1.example.com:7051');
...
module.exports.invoke_chaincode = invoke_chaincode;
